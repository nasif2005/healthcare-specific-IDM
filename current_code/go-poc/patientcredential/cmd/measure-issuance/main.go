// Command measure-issuance writes reproducible patient-credential issuance
// latency, communication, and storage measurements as JSON.
package main
...
func main() {
	...
	flag.Parse()
	result, err := pc.MeasurePatientCredentialIssuance(*iterations)
	if err != nil {
		log.Fatal(err)
	}
