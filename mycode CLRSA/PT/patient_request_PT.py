...
###
file_path = "/home/nmuslim162022/Desktop/mycode/PT/patient_pseudonym_data.json"
...
for i in range(num_iterations):
    ...
    print("e_hat1: ", e_hat)
    print("v_hat1: ", v_hat)
    print("sk_user_hat1: ", sk_user_hat)
    print("m_hat1: ", m_hat)
    """
    ...
    if is_valid:
        ...
        print("L The NIZK proof is INVALID. The request should be rejected.")
