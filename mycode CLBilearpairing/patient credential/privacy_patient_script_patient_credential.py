...
# File paths
FILE_PATH = "/home/nmuslim162022/Desktop/mycode2/patient credential/crypto_parameters.json"
...
for i in range(iterations):
    ...
    if response.status_code == 200: 
        try:
            ...
            with open(r'/home/nmuslim162022/Desktop/mycode2/patient credential/patient_credential_signature.json', 'w') as json_file:
